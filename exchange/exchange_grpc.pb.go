...
const (
	...
	ExchangeService_PerformExchange_FullMethodName  = "/exchange.ExchangeService/PerformExchange"
)
...
type ExchangeServiceClient interface {
	...
	PerformExchange(ctx context.Context, in *ExchangeRequest, opts ...grpc.CallOption) (*ExchangeResponse, error)
}
...
func (c *exchangeServiceClient) PerformExchange(ctx context.Context, in *ExchangeRequest, opts ...grpc.CallOption) (*ExchangeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExchangeResponse)
	err := c.cc.Invoke(ctx, ExchangeService_PerformExchange_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExchangeServiceServer interface {
	...
	PerformExchange(context.Context, *ExchangeRequest) (*ExchangeResponse, error)
...
func (UnimplementedExchangeServiceServer) PerformExchange(context.Context, *ExchangeRequest) (*ExchangeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PerformExchange not implemented")
}
...
func _ExchangeService_PerformExchange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExchangeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExchangeServiceServer).PerformExchange(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExchangeService_PerformExchange_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeServiceServer).PerformExchange(ctx, req.(*ExchangeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ExchangeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PerformExchange",
			Handler:    _ExchangeService_PerformExchange_Handler,
		},
	},
